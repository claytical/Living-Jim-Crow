...
function unlock(item) {
	...
	switch(item) {
		...
		case "newyorker1":
			...
			html +="<a href='https://www.newyorker.com/magazine/2018/02/05/what-does-it-mean-to-die' data-featherlight='iframe' data-featherlight-iframe-allowfullscreen>View</a>";
			break;
		case "michigantoday":
